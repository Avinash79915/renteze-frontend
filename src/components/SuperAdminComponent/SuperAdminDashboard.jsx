  ...
  const OverviewTab = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-l  border border-gray-200">
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="px-6 py-4">
          <h1 className="text-2xl font-bold text-[#1652A1]">Super Admin Dashboard</h1>
          <p className="text-gray-600">Manage all properties and administrators</p>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">{selectedProperty.name} Details</h2>
              <button 
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div>
                <p className="text-sm text-gray-600">Admin Assigned</p>
                <p className="font-medium">{selectedProperty.adminAssigned}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Total Units</p>
                <p className="font-medium">{selectedProperty.totalUnits}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Monthly Revenue</p>
                <p className="font-medium text-green-600">₹{selectedProperty.monthlyRent.toLocaleString()}</p>
              </div>
            </div>
